...
<body background="images/fondo1.6.png" style="background-attachment: fixed" >
	<center><div class="tit"><h2 style="color: #F39C12 ; ">Inicio de sesión</h2>
...
<form method="post" action="" >
  <fieldset>
    ...
    <div class="form-group">
      <label style="font-size: 14pt; color:"><b>Ingresa tu email</b></label>
